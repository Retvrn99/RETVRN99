...
GSW_VXD_OBJS = &
  pci.obj gsw_display_arbiter.obj gsw_display_adapter.obj gsw_transport.obj &
  gsw3d_transport.obj gsw3d_ioctl.obj gsw_ddraw.obj vxd_fbhda.obj &
...
gsw_display_arbiter.obj : gsw_display_arbiter.c gsw_display_arbiter.h .autodepend
	$(CC32) $(CFLAGS32) $(INCS) $(FLAGS) gsw_display_arbiter.c

gsw_display_adapter.obj : gsw_display_adapter.c gsw_display_adapter.h gsw_display_arbiter.h .autodepend
	$(CC32) $(CFLAGS32) $(INCS) $(FLAGS) gsw_display_adapter.c
...
file pci.obj
file gsw_display_arbiter.obj
file gsw_display_adapter.obj
