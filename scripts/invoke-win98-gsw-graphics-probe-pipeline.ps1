...
if ([string]::IsNullOrWhiteSpace($BuildPlan)) {
    $BuildPlan = Join-Path $PSScriptRoot `
        '..\drivers\win98\gsw-graphics-probe-build-plan.json'
}
...
Write-Output 'Built the hash-verified GSWGFX controller and bound GSWVBE companion.'
