...
Result :: struct {
	...
	desktop_primary_ide_dma_transactions: u64,
	desktop_primary_ide_dma_bytes:        u64,
...
Disk_Result :: struct {
	...
	desktop_primary_ide_dma_transactions: u64 `json:"desktop_primary_ide_dma_transactions"`,
	desktop_primary_ide_dma_bytes:        u64 `json:"desktop_primary_ide_dma_bytes"`,
...
result_save :: proc(path: string, result: ^Result) -> Result_Diagnostic {
	...
	disk := Disk_Result {
		...
		desktop_primary_ide_dma_transactions = result.desktop_primary_ide_dma_transactions,
		desktop_primary_ide_dma_bytes        = result.desktop_primary_ide_dma_bytes,
