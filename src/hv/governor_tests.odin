...
test_governor_gsw_886_tracks_wait_overshoot :: proc(t: ^testing.T) {
	...
	testing.expect_value(t, governor_charge(&g, 250_000, 250_000), i64(750_000))
	governor_record_wait(&g, 900_000)
	testing.expect_value(t, g.balance_ns, i64(-150_000))
	testing.expect_value(t, governor_charge(&g, 250_000, 250_000), i64(600_000))
}
...
test_governor_gsw_886_does_not_bank_idle_time :: proc(t: ^testing.T) {
	...
	testing.expect_value(t, governor_charge(&g, 500_000, 500_000), i64(500_000))
}
...
test_governor_carries_large_debt_across_waits :: proc(t: ^testing.T) {
	...
	testing.expect_value(t, g.balance_ns, i64(150_000_000))
	governor_record_wait(&g, GOVERNOR_MAX_SLEEP_NS)
	testing.expect_value(t, governor_charge(&g, 0, 0), i64(50_000_000))
}
...
test_governor_uses_full_wall_interval :: proc(t: ^testing.T) {
	...
	testing.expect_value(t, governor_charge(&g, 50_000_000, 180_000_000), i64(20_000_000))
}
